...
public class MenuFrame extends JFrame 
{
   ...
   private final JCheckBoxMenuItem[] styleItems; // itens de menu de estilo de fonte
   private final JLabel displayJLabel; // exibe texto de exemplo
   private final ButtonGroup fontButtonGroup; // gerencia itens do menu de fontes
   private final ButtonGroup colorButtonGroup; // gerencia itens de menu de cores
   private int style; // usado para criar estilo para fonte

   // GUI de configuração de construtor sem argumentos
   public MenuFrame()
   {
      super("Using JMenus");     
      ...
      // cria Sobre... item de menu
      JMenuItem aboutItem = new JMenuItem("About...");
      aboutItem.setMnemonic('A'); // definir mnemônico para A
      fileMenu.add(aboutItem); // adicionar sobre o item ao menu de arquivo
